...
import './findaplace_3.css'
import ImgAsset from '../public'
import {Link} from 'react-router-dom'
export default function Findaplace_3 () {
	return (
		<div className='findaplace_3_findaplace'>
			<div className='Rectangle9'/>
			<img className='Vector' src = {ImgAsset.findaplace_3_Vector} />
			<img className='Vector_1' src = {ImgAsset.findaplace_3_Vector_1} />
			...
			<img className='_' src = {ImgAsset.findaplace_3__} />
			<div className='__1'/>
