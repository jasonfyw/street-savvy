...
import './findaplace_4.css'
import ImgAsset from '../public'
import {Link} from 'react-router-dom'
export default function Findaplace_4 () {
	return (
		<div className='findaplace_4_findaplace'>
			<div className='Rectangle9'/>
			<img className='Vector' src = {ImgAsset.findaplace_4_Vector} />
			<img className='Vector_1' src = {ImgAsset.findaplace_4_Vector_1} />
